...
const StartGame = () => {
    return (<div className={classes.gridGrid}>
        <div >
            <img  className={classes.gridGridPhoto} src={ 'https://sun9-48.userapi.com/impg/2nZY-qwzGXms51j-JamMDyB_BH45iLfsBStySw/CNk9u93oMJA.jpg?size=1068x717&quality=96&sign=dcba67c3d02f64bb1562d9155d9ea3ca&type=album'} />
        </div>
