    ...
    return (<div>
        <div className={classes.grid}>
            <div className={classes.gridLeft}>
                <div >
                    <img className={classes.Photo1}  src={'https://phonoteka.org/uploads/posts/2021-07/1625109324_23-phonoteka_org-p-oboi-na-rabochii-stol-minimalizm-gori-kras-24.jpg'}/>
                </div>
